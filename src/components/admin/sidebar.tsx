  ...
  return (
    <aside className="fixed left-0 top-0 z-40 hidden h-screen w-[260px] flex-col border-r border-[#2A2A2A] bg-[#1A1A1A] p-4 lg:flex">
      <Link href="/admin" className="mb-8 flex items-center gap-2 px-3">
        ...
        <span className="rounded-full bg-[rgba(239,68,68,0.2)] px-2 py-0.5 text-[10px] font-bold text-[#EF4444]">
          Admin
        </span>
      </Link>
      ...
      <div className="border-t border-[#2A2A2A] pt-4">
        <Link
          href="/"
          className="flex items-center gap-3 rounded-[16px] px-4 py-3 text-sm text-[#A0A0A0] hover:bg-[#252525] hover:text-white"
        >
          ← 사이트로 돌아가기
        </Link>
      </div>
