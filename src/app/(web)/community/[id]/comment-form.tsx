    ...
    <div className="mt-4">
      ...
      <form ref={formRef} action={formAction} className="flex gap-2">
        ...
        <input
          ...
          type="text"
          required
          className="flex-1 rounded-[16px] border-none bg-[var(--color-border)] px-4 py-3 text-sm text-[var(--color-text-primary)] placeholder:text-[var(--color-text-muted)] focus:outline-none focus:ring-2 focus:ring-[var(--color-accent)]/50"
          placeholder="댓글 입력..."
        />
        <button
          type="submit"
