...
export function BracketEmpty({ tournamentId }: { tournamentId: string }) {
  return (
    <div className="flex flex-col items-center justify-center rounded-xl border border-[var(--color-border)] bg-[var(--color-card)] py-16 px-6 text-center" style={{ boxShadow: "var(--shadow-card)" }}>
