...
## 현재 작업
- **요청**: D→C→B→A 순 — D✅ referee 알림 사일런트 버그 해소 / C(W4 L1 라벨 정리) 대기
- **상태**: 🟢 D 수정 완료, 커밋 대기
- **현재 담당**: pm
...
| 날짜 | 담당 | 작업 | 결과 |
|------|------|------|------|
| 04-20 | pm | **referee 알림 사일런트 버그 해소** (errors.md 6회차 재발). notification-bell.tsx + notifications/page.tsx: `json?.data` → `json` 직접 접근 + apiSuccess 래핑 없음 주석 가드. errors.md 해소 표시 | ✅ 커밋 대기 |
...
| 04-19 | developer | `/games` 경기 유형 탭 + 건수 뱃지 (route.ts groupBy 1회) | ✅ 1082124 + 1e7b642 |
